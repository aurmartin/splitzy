 ...
 * for example: if the APP_ENV is preview, the bundle id will be com.aurmartin.splitzy.preview
 */
...
const BUNDLE_ID = "com.aurmartin.splitzy"; // ios bundle id
const PACKAGE = "com.aurmartin.splitzy"; // android package name
const NAME = name(); // app name
const EXPO_ACCOUNT_OWNER = "aurmartin"; // expo account owner
const EAS_PROJECT_ID = "4831c29a-5aed-4996-8ffa-a02e3e0f443c"; // eas project id
const SCHEME = scheme(); // app scheme
